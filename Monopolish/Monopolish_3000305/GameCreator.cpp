...
bool GameCreator::readMonopolyTextFile()
{
...
vector<string> GameCreator::separateLine(string line)
{
...
void GameCreator::createSquareObjects(vector<string> lineVector)
{
...
bool GameCreator::readSeedTextFile(int& seed)
{
...
// get square details
void GameCreator::getSquares(c_square& squares)
{
